import {
  ...
  set_should_intro,
  should_intro
} from "./chunk-KQQZVXUO.js";
import {
  create_event,
  delegate,
  delegated
} from "./chunk-DUD7STUZ.js";
import {
  clsx
...
function transition(flags, element2, get_fn, get_params) {
  ...
  ((_a = e.nodes).t ?? (_a.t = [])).push(transition2);
...
function set_attributes(element2, prev, next2, css_hash, should_remove_defaults = false, skip_warning = false) {
  ...
  if (element2.nodeName === INPUT_TAG && "type" in next2 && ("value" in next2 || "__value" in next2)) {
    ...
    if (type !== current.type || type === void 0 && element2.hasAttribute("type")) {
      current.type = type;
      set_attribute(element2, "type", type, skip_warning);
    }
  }
...
function get_attributes(element2) {
  ...
  return (
    ...
    /** @type {any} */
    element2[_a = ATTRIBUTES_CACHE] ?? (element2[_a] = {
...
function is_supported() {
  ...
  if (supported === null) {
    ...
    ((_b = (_a = select.firstChild) == null ? void 0 : _a.firstChild) == null ? void 0 : _b.nodeType) === 1;
  }
  return supported;
}
  ...
  attach(element2, () => () => {
    ...
    const observer = new MutationObserver((entries) => {
      ...
      for (const entry of entries) {
        ...
        selected || (selected = !!((_b = (_a = entry.target.parentElement) == null ? void 0 : _a.closest("option")) == null ? void 0 : _b.selected));
      }
      if (selected) {
...
//# sourceMappingURL=chunk-HWX6NDMZ.js.map
